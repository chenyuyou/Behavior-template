...
class Trial(ExtraModel):
    ...
    instant_payoff = models.CurrencyField()
    delay_payoff = models.CurrencyField()
    chose_lottery = models.BooleanField()
...
class Stimuli(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.chose_lottery:
            payoff = trial.delay_payoff
        else:
            payoff = trial.instant_payoff
#            player.won_lottery = trial.probability > random.random()
